 ...
 */ (function (e) {
  ...
  function r(w) {
    ...
    if (T !== z) {
      w[0] = T;
      e: for (var K = 0, q = w.length, nr = q >>> 1; K < nr; ) {
        var kn = 2 * (K + 1) - 1,
          Sl = w[kn],
          En = kn + 1,
          tr = w[En];
        if (0 > l(Sl, T))
          En < q && 0 > l(tr, Sl)
            ? ((w[K] = tr), (w[En] = T), (K = En))
            : ((w[K] = Sl), (w[kn] = T), (K = kn));
        else if (En < q && 0 > l(tr, T)) (w[K] = tr), (w[En] = T), (K = En);
        else break e;
      }
    }
    return z;
  ...
  function l(w, z) {
    var T = w.sortIndex - z.sortIndex;
    return T !== 0 ? T : w.id - z.id;
  }
  ...
  function v(w) {
    if (((k = !1), d(w), !S))
      if (t(s) !== null) (S = !0), _e(C);
      else {
        var z = t(c);
        z !== null && ne(v, z.startTime - w);
      }
  }
  function C(w, z) {
    (S = !1), k && ((k = !1), f(N), (N = -1)), (g = !0);
    var T = p;
    try {
      for (
        d(z), h = t(s);
        h !== null && (!(h.expirationTime > z) || (w && !R()));
      ...
      if (h !== null) var nr = !0;
        ...
        var kn = t(c);
        kn !== null && ne(v, kn.startTime - z), (nr = !1);
      }
      return nr;
    } finally {
      (h = null), (p = T), (g = !1);
  ...
  (e.unstable_IdlePriority = 5),
    ...
    (e.unstable_scheduleCallback = function (w, z, T) {
      ...
      return (
        ...
        T > K
          ? ((w.sortIndex = T),
            ...
            t(s) === null &&
              w === t(c) &&
              (k ? (f(N), (N = -1)) : (k = !0), ne(v, T - K)))
          : ((w.sortIndex = q), n(s, w), S || g || ((S = !0), _e(C))),
        w
      );
    }),
...
var be = Pc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function ei(e, n) {
  ...
  n.hasOwnProperty("value")
    ? ni(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && ni(e, n.type, vn(n.defaultValue)),
    n.checked == null &&
...
function Qo(e) {
  if ((e = bt(e))) {
    ...
    var n = e.stateNode;
    n && ((n = al(n)), ui(e.stateNode, e.type, n));
  }
}
function vs(e) {
...
function Uc(e, n, t, r, l, i, o, u, s) {
  (_t = !1), (Dr = null), Fc.apply(jc, arguments);
}
function $c(e, n, t, r, l, i, o, u, s) {
  if ((Uc.apply(this, arguments), _t)) {
    if (_t) {
      var c = Dr;
      (_t = !1), (Dr = null);
...
var xs = Ee.unstable_scheduleCallback,
  Yo = Ee.unstable_cancelCallback,
  Vc = Ee.unstable_shouldYield,
  Bc = Ee.unstable_requestPaint,
  Y = Ee.unstable_now,
  Hc = Ee.unstable_getCurrentPriorityLevel,
  Ji = Ee.unstable_ImmediatePriority,
  _s = Ee.unstable_UserBlockingPriority,
  Fr = Ee.unstable_NormalPriority,
  Wc = Ee.unstable_LowPriority,
...
var Fe = Math.clz32 ? Math.clz32 : Xc,
  Kc = Math.log,
  Yc = Math.LN2;
function Xc(e) {
...
function bc(e, n, t, r, l) {
  switch (n) {
    ...
    case "mouseover":
      return (cn = ht(cn, e, n, t, r, l)), !0;
    case "pointerover":
      var i = l.pointerId;
      return Ft.set(i, ht(Ft.get(i) || null, e, n, t, r, l)), !0;
    case "gotpointercapture":
      return (
        (i = l.pointerId), jt.set(i, ht(jt.get(i) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
...
function mt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
      ...
      ((fi = !0),
      Ee.unstable_scheduleCallback(Ee.unstable_NormalPriority, ef)));
}
function Ut(e) {
  function n(l) {
    return mt(l, e);
...
var bn = be.ReactCurrentBatchConfig,
  Ur = !0;
function nf(e, n, t, r) {
  var l = O,
    i = bn.transition;
...
var $r = null;
function di(e, n, t, r) {
  if ((($r = null), (e = Zi(r)), (e = _n(e)), e !== null))
...
var ct = {
  ...
  Jo = xe(ol),
  lf = W({}, ol, { dataTransfer: 0 }),
  of = xe(lf),
  uf = W({}, qt, { relatedTarget: 0 }),
  Tl = xe(uf),
  sf = W({}, ct, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = xe(sf),
  cf = W({}, ct, {
...
var yf = W({}, qt, {
  ...
  kf = xe(Sf),
  Ef = W({}, ct, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = xe(Ef),
  xf = W({}, ol, {
    deltaX: function (e) {
  ...
  Pt = null;
Ge && "documentMode" in document && (Pt = document.documentMode);
var Nf = Ge && "TextEvent" in window && !Pt,
  Fs = Ge && (!lo || (Pt && 8 < Pt && 11 >= Pt)),
  eu = " ",
  nu = !1;
function js(e, n) {
  switch (e) {
...
function Vs(e) {
  if (e.propertyName === "value" && ul($t)) {
    var n = [];
    $s(n, $t, e, Zi(e)), Ss(Rf, n);
  }
}
function Of(e, n, t) {
  e === "focusin"
    ? (lu(), (Nt = n), ($t = t), Nt.attachEvent("onpropertychange", Vs))
    : e === "focusout" && lu();
}
function Df(e) {
...
var Ue = typeof Object.is == "function" ? Object.is : jf;
function At(e, n) {
  if (Ue(e, n)) return !0;
  ...
  for (r = 0; r < t.length; r++) {
    var l = t[r];
    if (!Xl.call(n, l) || !Ue(e[l], n[l])) return !1;
  }
  return !0;
}
function iu(e) {
...
var $f = Ge && "documentMode" in document && 11 >= document.documentMode,
  Vn = null,
  pi = null,
  zt = null,
  hi = !1;
...
var Qs = sl("animationend"),
  Ks = sl("animationiteration"),
...
gn(Qs, "onAnimationEnd");
gn(Ks, "onAnimationIteration");
gn(Ys, "onAnimationStart");
gn("dblclick", "onDoubleClick");
gn("focusin", "onFocus");
gn("focusout", "onBlur");
gn(Xs, "onTransitionEnd");
...
var Ct =
  ...
  Bf = new Set("cancel close invalid load scroll toggle".split(" ").concat(Ct));
function au(e, n, t) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = It(a, f)), v != null && k.push(Bt(a, v, d)))),
            D)
          )
            break;
          a = a.return;
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            n: {
              for (k = g, f = S, a = 0, d = k; d; d = jn(d)) a++;
      ...
      N &&
        (Fs &&
          ...
          (An || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && An && (E = Is())
            : ((on = m),
              (no = "value" in on ? on.value : on.textContent),
              (An = !0))),
        (_ = Ar(c, N)),
        0 < _.length &&
          ((N = new qo(N, e, null, t, m)),
          h.push({ event: N, listeners: _ }),
          E ? (N.data = E) : ((E = Us(t)), E !== null && (N.data = E)))),
        (E = Nf ? zf(e, t) : Tf(e, t)) &&
          ((c = Ar(c, "onBeforeInput")),
          0 < c.length &&
            ((m = new qo("onBeforeInput", "beforeinput", null, t, m)),
...
function hu(e, n, t) {
  if (ae.current !== yn) throw Error(y(168));
  I(ae, n), I(ve, t);
}
function qs(e, n, t) {
  var r = e.stateNode;
...
function Sn() {
  if (!Ul && Qe !== null) {
    ...
    try {
      ...
      throw (Qe !== null && (Qe = Qe.slice(e + 1)), xs(Ji, Sn), l);
    } finally {
      (O = n), (Ul = !1);
    }
  }
...
var Qn = [],
  ...
  Ye = "";
function Cn(e, n) {
  (Qn[Kn++] = Qr), (Qn[Kn++] = Wr), (Wr = e), (Qr = n);
}
function ea(e, n, t) {
  (Pe[Ne++] = Ke), (Pe[Ne++] = Ye), (Pe[Ne++] = Rn), (Rn = e);
  var r = Ke;
  e = Ye;
  var l = 32 - Fe(r) - 1;
  (r &= ~(1 << l)), (t += 1);
  ...
  if (30 < i) {
    ...
    (i = (r & ((1 << o) - 1)).toString(32)),
      (r >>= o),
      (l -= o),
      (Ke = (1 << (32 - Fe(n) + l)) | (t << l) | r),
      (Ye = i + e);
  } else (Ke = (1 << i) | (t << l) | r), (Ye = e);
}
function oo(e) {
  e.return !== null && (Cn(e, 1), ea(e, 1, 0));
}
function uo(e) {
  for (; e === Wr; )
    (Wr = Qn[--Kn]), (Qn[Kn] = null), (Qr = Qn[--Kn]), (Qn[Kn] = null);
  for (; e === Rn; )
    (Rn = Pe[--Ne]),
      (Pe[Ne] = null),
      (Ye = Pe[--Ne]),
      ...
      return (
        (n =
          n.nodeType !== 1 || t.toLowerCase() !== n.nodeName.toLowerCase()
            ...
            : n),
        n !== null
          ? ((e.stateNode = n), (ke = e), (Se = fn(n.firstChild)), !0)
          : !1
      );
    case 6:
      return (
        (n = e.pendingProps === "" || n.nodeType !== 3 ? null : n),
        n !== null ? ((e.stateNode = n), (ke = e), (Se = null), !0) : !1
      );
    case 13:
      return (
        (n = n.nodeType !== 8 ? null : n),
        n !== null
          ? ((t = Rn !== null ? { id: Ke, overflow: Ye } : null),
            (e.memoizedState = {
              dehydrated: n,
              treeContext: t,
...
function hr(e) {
  ...
  if (
    ...
    for (; n; ) na(e, n), (n = fn(n.nextSibling));
  }
  if ((yu(e), e.tag === 13)) {
  ...
  } else Se = ke ? fn(e.stateNode.nextSibling) : null;
  return !0;
}
function ta() {
  for (var e = Se; e; ) e = fn(e.nextSibling);
}
function lt() {
  (Se = ke = null), ($ = !1);
}
...
var Jf = be.ReactCurrentBatchConfig;
function yt(e, n, t) {
  if (
...
function ra(e) {
  ...
  function m(f, a, d, v, C) {
    return a === null || a.tag !== 7
      ? ((a = Tn(d, f.mode, v, C)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function h(f, a, d) {
  ...
  function p(f, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (kt(d) || dt(d)) return C !== null ? null : m(f, a, d, v, null);
      mr(f, d);
    }
    return null;
  }
  function g(f, a, d, v, C) {
    ...
    if (typeof v == "object" && v !== null) {
      ...
      if (kt(v) || dt(v)) return (f = f.get(d) || null), m(a, f, v, C, null);
      mr(a, v);
    }
    return null;
  }
  function S(f, a, d, v) {
    for (
      var C = null, _ = null, E = a, N = (a = 0), A = null;
      E !== null && N < d.length;
      N++
    ) {
      ...
      e && E && P.alternate === null && n(f, E),
        (a = i(P, a, N)),
        _ === null ? (C = P) : (_.sibling = P),
        (_ = P),
        (E = A);
    }
    if (N === d.length) return t(f, E), $ && Cn(f, N), C;
    if (E === null) {
      for (; N < d.length; N++)
        (E = h(f, d[N], v)),
          E !== null &&
            ((a = i(E, a, N)), _ === null ? (C = E) : (_.sibling = E), (_ = E));
      return $ && Cn(f, N), C;
    }
    for (E = r(f, E); N < d.length; N++)
      (A = g(E, f, N, d[N], v)),
        A !== null &&
          (e && A.alternate !== null && E.delete(A.key === null ? N : A.key),
          (a = i(A, a, N)),
  ...
  function k(f, a, d, v) {
    ...
    for (
      var _ = (C = null), E = a, N = (a = 0), A = null, P = d.next();
      E !== null && !P.done;
      N++, P = d.next()
    ) {
      E.index > N ? ((A = E), (E = null)) : (A = E.sibling);
      var R = p(f, E, P.value, v);
      if (R === null) {
        E === null && (E = A);
        break;
      }
      e && E && R.alternate === null && n(f, E),
        (a = i(R, a, N)),
        _ === null ? (C = R) : (_.sibling = R),
        (_ = R),
        (E = A);
    }
    if (P.done) return t(f, E), $ && Cn(f, N), C;
    if (E === null) {
      for (; !P.done; N++, P = d.next())
        (P = h(f, P.value, v)),
          P !== null &&
            ((a = i(P, a, N)), _ === null ? (C = P) : (_.sibling = P), (_ = P));
      return $ && Cn(f, N), C;
    }
    for (E = r(f, E); !P.done; N++, P = d.next())
      (P = g(E, f, N, P.value, v)),
        P !== null &&
      ...
      switch (d.$$typeof) {
        case lr:
          e: {
            ...
            d.type === $n
              ? ((a = Tn(d.props.children, f.mode, v, d.key)),
                (a.return = f),
                (f = a))
              : ((v = Rr(d.type, d.key, d.props, null, f.mode, v)),
                (v.ref = yt(f, a, d)),
...
function Le(e) {
  ...
  if (ao !== e)
    if (((e = { context: e, memoizedValue: n, next: null }), Yn === null)) {
      ...
      (Yn = e), (Yr.dependencies = { lanes: 0, firstContext: e });
    } else Yn = Yn.next = e;
  return n;
}
var Pn = null;
...
function wo(e, n, t, r, l, i) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (Pr.current = e === null || e.memoizedState === null ? td : rd),
    (e = t(r, l)),
    Tt)
  ) {
    i = 0;
...
function Re() {
  ...
  var n = b === null ? H.memoizedState : b.next;
  if (n !== null) (b = n), (G = e);
  else {
...
function Vl(e) {
  ...
  if (((e = t.interleaved), e !== null)) {
    l = e;
    do (i = l.lane), (H.lanes |= i), (On |= i), (l = l.next);
    while (l !== e);
...
function fa(e, n, t, r) {
  (n.value = t), (n.getSnapshot = r), pa(n) && ha(e);
}
function da(e, n, t) {
  return t(function () {
    pa(n) && ha(e);
...
function wa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), fl(4, 4, ga.bind(null, n, e), t)
  );
}
function Eo() {}
function Sa(e, n) {
...
function Ea(e, n, t) {
  return Mn & 21
    ? (Ue(t, n) || ((t = Ns()), (H.lanes |= t), (On |= t), (e.baseState = !0)),
      n)
...
function nd(e, n, t) {
  ...
  if (xa(e)) _a(n, l);
    ...
    (t = ia(e, n, l, r)),
      t !== null && ((l = fe()), je(t, e, r, l), Pa(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
var Jr = {
  ...
  td = {
    ...
    useTransition: function () {
      var e = ku(!1),
        n = e[0];
      return (e = bf.bind(null, e[1])), (Ae().memoizedState = e), [n, e];
    },
...
function Na(e, n, t) {
  ...
  return (
    typeof i == "object" && i !== null
      ? (i = Le(i))
      : ((l = ye(n) ? Ln : ae.current),
        (r = n.contextTypes),
        (i = (r = r != null) ? rt(e, l) : yn)),
    (n = new n(t, i)),
...
function _i(e, n, t, r) {
  ...
  typeof i == "object" && i !== null
    ? (l.context = Le(i))
    : ((i = ye(n) ? Ln : ae.current), (l.context = rt(e, i))),
...
var od = be.ReactCurrentOwner,
  me = !1;
function ce(e, n, t, r) {
  n.child = e === null ? la(n, null, t, r) : it(n, e.child, t, r);
}
  ...
  return (
    ...
    e !== null && !me
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        qe(e, n, l))
      : ($ && t && oo(n), (n.flags |= 1), ce(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !me
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        qe(e, n, l))
      : ($ && r && oo(n), (n.flags |= 1), ce(e, n, t, l), n.child)
  );
}
function Lu(e, n, t, r, l) {
  ...
  if ((et(n, l), n.stateNode === null))
    zr(e, n), Na(n, t, r), _i(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
    ...
    (o = n.stateNode),
      oa(e, n),
      (u = n.memoizedProps),
      (c = n.type === n.elementType ? u : Oe(n.type, u)),
      (o.props = c),
      (h = n.pendingProps),
      (p = o.context),
      (s = t.contextType),
    ...
    u !== h || p !== S || ve.current || tn
      ? (typeof g == "function" && (xi(n, t, g, r), (S = n.memoizedState)),
...
function zi(e, n, t, r, l, i) {
  Ma(e, n);
  var o = (n.flags & 128) !== 0;
  if (!r && !o) return l && mu(n, t, !1), qe(e, n, i);
...
function Ru(e, n, t, r, l) {
  return lt(), so(l), (n.flags |= 256), ce(e, n, t, r), n.child;
}
...
function Da(e, n, t) {
  ...
  if (i) {
    ...
    return (
      ...
      u !== null ? (i = mn(u, i)) : ((i = Tn(i, o, t, null)), (i.flags |= 2)),
      (i.return = n),
      (r.return = n),
      (r.sibling = i),
      (n.child = r),
  ...
  if (((u = (o & e.childLanes) !== 0), me || u)) {
    if (((r = ee), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 &&
          l !== i.retryLane &&
          ((i.retryLane = l), Je(e, l), je(r, e, l, -1));
    }
...
function Ia(e, n, t) {
  var r = n.pendingProps,
    l = r.revealOrder,
    i = r.tail;
  if ((ce(e, n, r.children, t), (r = B.current), r & 2))
    (r = (r & 1) | 2), (n.flags |= 128);
  else {
  ...
  switch ((uo(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (hr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Ie !== null && ($i(Ie), (Ie = null)))),
        Ri(e, n),
        ue(n),
        null
      );
    case 5:
      ...
      if (((t = n.type), e !== null && n.stateNode != null))
        ...
        if (((e = Nn(He.current)), hr(n))) {
          (r = n.stateNode), (t = n.type);
          var i = n.memoizedProps;
          switch (((r[Ve] = n), (r[Ht] = i), (e = (n.mode & 1) !== 0), t)) {
            case "dialog":
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = Nn(Qt.current)), Nn(He.current), hr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ve] = n),
            (i = r.nodeValue !== t) && ((e = ke), e !== null))
          )
            switch (e.tag) {
              case 3:
    ...
    case 13:
      if (
        ...
        if ($ && Se !== null && n.mode & 1 && !(n.flags & 128))
          ta(), lt(), (n.flags |= 98560), (i = !1);
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((n.child.flags |= 8192),
            n.mode & 1 &&
              (e === null || B.current & 1 ? Z === 0 && (Z = 3) : To())),
          n.updateQueue !== null && (n.flags |= 4),
          ue(n),
          null);
    case 4:
      return (
        ot(), Ri(e, n), e === null && Vt(n.stateNode.containerInfo), ue(n), null
      );
    case 10:
      return fo(n.type._context), ue(n), null;
    case 17:
      return ye(n.type) && Br(), ue(n), null;
    case 19:
      if ((U(B), (i = n.memoizedState), i === null)) return ue(n), null;
    ...
    case 23:
      return (
        ...
        r && n.mode & 1
          ? we & 1073741824 && (ue(n), n.subtreeFlags & 6 && (n.flags |= 8192))
          : ue(n),
        null
      );
    case 24:
...
function dd(e, n) {
  ...
  for (vi = { focusedElem: e, selectionRange: t }, Ur = !1, x = n; x !== null; )
                ...
                if (S !== null) {
                  var k = S.memoizedProps,
                    ...
                    a = f.getSnapshotBeforeUpdate(
                      n.elementType === n.type ? k : Oe(n.type, k),
                      D,
                    );
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ve], delete n[Ht], delete n[wi], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Va(e, n, t) {
  ...
  switch (t.tag) {
    ...
    case 22:
      t.mode & 1
        ? ((se = (r = se) || t.memoizedState !== null), en(e, n, t), (se = r))
        : en(e, n, t);
      break;
    default:
      en(e, n, t);
...
function Ba(e, n) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Me(n, e), $e(e), r & 512 && t !== null && Xn(t, t.return);
      break;
    case 5:
      if (
        (Me(n, e),
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((se = (c = se) || m), Me(n, e), (se = c)) : Me(n, e),
        $e(e),
        r & 8192)
      ) {
        if (
...
var hd = Math.ceil,
  qr = be.ReactCurrentDispatcher,
  xo = be.ReactCurrentOwner,
  Te = be.ReactCurrentBatchConfig,
  M = 0,
  ee = null,
  X = null,
  re = 0,
...
function je(e, n, t, r) {
  if (50 < Mt) throw ((Mt = 0), (ji = null), Error(y(185)));
  Jt(e, t, r),
    (!(M & 2) || e !== ee) &&
      (e === ee && (!(M & 2) && (hl |= t), Z === 4 && ln(e, re)),
      ge(e, r),
      t === 1 && M === 0 && !(n.mode & 1) && ((st = Y() + 500), cl && Sn()));
}
function ge(e, n) {
  var t = e.callbackNode;
  Zc(e, n);
  var r = jr(e, e === ee ? re : 0);
  if (r === 0)
...
function Wa(e, n) {
  if (((Tr = -1), (Lr = 0), M & 6)) throw Error(y(327));
  var t = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || n) n = nl(e, r);
    ...
    M |= 2;
    var i = Ka();
    (ee !== e || re !== n) && ((We = null), (st = Y() + 500), zn(e, n));
    do
      try {
        yd();
        break;
    ...
    co(),
      (qr.current = i),
      (M = l),
      X !== null ? (n = 0) : ((ee = null), (re = 0), (n = Z));
  }
  if (n !== 0) {
    if (
      (n === 2 && ((l = ci(e)), l !== 0 && ((r = l), (n = Ui(e, l)))), n === 1)
    )
      throw ((t = Gt), zn(e, 0), ln(e, r), ge(e, Y()), t);
    if (n === 6) ln(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (ln(e, r), (r & 130023424) === r && ((n = Po + 500 - Y()), 10 < n))
          ) {
            if (jr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = gi(xn.bind(null, e, he, We), n);
            break;
          }
          xn(e, he, We);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = gi(xn.bind(null, e, he, We), r);
            break;
          }
          xn(e, he, We);
          break;
  ...
  return ge(e, Y()), e.callbackNode === t ? Wa.bind(null, e) : null;
}
function Ui(e, n) {
  var t = Rt;
  return (
...
function $u(e) {
  ...
  nt();
  var n = jr(e, 0);
  if (!(n & 1)) return ge(e, Y()), null;
  var t = nl(e, n);
  if (e.tag !== 0 && t === 2) {
    var r = ci(e);
    r !== 0 && ((n = r), (t = Ui(e, r)));
  }
  if (t === 1) throw ((t = Gt), zn(e, 0), ln(e, n), ge(e, Y()), t);
...
function No(e, n) {
  ...
  try {
    ...
    (M = t), M === 0 && ((st = Y() + 500), cl && Sn());
  }
}
function Dn(e) {
  un !== null && un.tag === 0 && !(M & 6) && nt();
  var n = M;
  M |= 1;
  var t = Te.transition,
    r = O;
  try {
    ...
    (O = r), (Te.transition = t), (M = n), !(M & 6) && Sn();
  }
}
function zo() {
  (we = Gn.current), U(Gn);
...
function To() {
  (Z === 0 || Z === 3 || Z === 2) && (Z = 4),
    ee === null || (!(On & 268435455) && !(hl & 268435455)) || ln(ee, re);
}
function nl(e, n) {
  var t = M;
  M |= 2;
  var r = Ka();
  (ee !== e || re !== n) && ((We = null), zn(e, n));
  do
    try {
      vd();
      break;
  ...
  while (!0);
  if ((co(), (M = t), (qr.current = r), X !== null)) throw Error(y(261));
...
function xn(e, n, t) {
  var r = O,
    l = Te.transition;
  try {
    (Te.transition = null), (O = 1), gd(e, n, t, r);
  } finally {
    (Te.transition = l), (O = r);
  }
  return null;
...
function nt() {
  if (un !== null) {
    var e = zs(el),
      ...
      t = O;
    try {
      if (((Te.transition = null), (O = 16 > e ? 16 : e), un === null))
        var r = !1;
      else {
        if (((e = un), (un = null), (el = 0), M & 6)) throw Error(y(331));
        var l = M;
        ...
        if (
          ((M = l), Sn(), Be && typeof Be.onPostCommitFiberRoot == "function")
        )
          try {
...
function wd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    ee === e &&
      (re & t) === t &&
      (Z === 4 || (Z === 3 && (re & 130023424) === re && 500 > Y() - Po)
        ? zn(e, 0)
        : (_o |= t)),
    ge(e, n);
}
function Ga(e, n) {
  n === 0 &&
    (e.mode & 1
      ...
      : (n = 1));
  var t = fe();
  (e = Je(e, n)), e !== null && (Jt(e, n, t), ge(e, t));
}
function Sd(e) {
  var n = e.memoizedState,
    t = 0;
...
Za = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ve.current) me = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (me = !1), sd(e, n, t);
      me = !!(e.flags & 131072);
    }
  else (me = !1), $ && n.flags & 1048576 && ea(n, Qr, n.index);
  switch (((n.lanes = 0), n.tag)) {
    case 2:
      var r = n.type;
      zr(e, n), (e = n.pendingProps);
      var l = rt(n, ae.current);
      et(n, t), (l = wo(null, n, r, e, l, t));
      var i = So();
      return (
        (n.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            _i(n, r, e, t),
            (n = zi(null, n, r, !0, i, t)))
          : ((n.tag = 0), $ && i && oo(n), ce(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = ut(Error(y(423)), n)), (n = Ru(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = ut(Error(y(424)), n)), (n = Ru(e, n, r, t, l));
            break e;
          } else
            for (
              Se = fn(n.stateNode.containerInfo.firstChild),
                ke = n,
                $ = !0,
                Ie = null,
                t = la(n, null, r, t),
    ...
    case 4:
      return (
        mo(n, n.stateNode.containerInfo),
        (r = n.pendingProps),
        e === null ? (n.child = it(n, null, r, t)) : ce(e, n, r, t),
        n.child
      );
    case 11:
      return (
...
function Rr(e, n, t, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) Lo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Gl:
        return (
          (e = ze(12, t, n, l | 2)), (e.elementType = Gl), (e.lanes = i), e
        );
      case Zl:
        return (e = ze(13, t, n, l)), (e.elementType = Zl), (e.lanes = i), e;
      case Jl:
        return (e = ze(19, t, n, l)), (e.elementType = Jl), (e.lanes = i), e;
      case us:
        return ml(t, l, i, n);
      default:
  ...
  return (
    (n = ze(o, t, n, l)), (n.elementType = e), (n.type = r), (n.lanes = i), n
  );
}
function Tn(e, n, t, r) {
...
yl.prototype.render = Oo.prototype.render = function (e) {
  var n = this._internalRoot;
  if (n === null) throw Error(y(409));
  vl(e, n, null, null);
};
yl.prototype.unmount = Oo.prototype.unmount = function () {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qi(n, t | 1), ge(n, Y()), !(M & 6) && ((st = Y() + 500), Sn()));
      }
      break;
    case 13:
      Dn(function () {
...
gs = No;
ws = Dn;
var zd = { usingClientEntryPoint: !1, Events: [bt, Hn, al, vs, ys, No] },
  wt = {
  ...
  Td = {
    ...
    findFiberByHostInstance: wt.findFiberByHostInstance || Pd,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!wr.isDisabled && wr.supportsFiber)
    try {
      (il = wr.inject(Td)), (Be = wr);
    } catch {}
}
Ce.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zd;
...
function Rd() {
  var e = Math.random,
    ...
    a = 0.7 - f;
  function d(P, R, V) {
    return ((1 - n(r * V)) / 2) * (R - P) + P;
  }
  var v = 1 / h,
    C = v + v;
  function _() {
    for (var P = [v, 1 - v], R = 1 - C, V = [0, 1]; R; ) {
      var ie = R * e(),
        F,
        J,
        _e,
        ...
        z,
        T;
      for (F = 0, J = P.length, R = 0; F < J; F += 2) {
        if (((ne = P[F]), (w = P[F + 1]), (_e = w - ne), ie < R + _e)) {
          V.push((ie += ne - R));
          break;
        }
        R += _e;
      }
      for (z = ie - v, T = ie + v, F = P.length - 1; F > 0; F -= 2)
        (J = F - 1),
          (ne = P[J]),
          (w = P[F]),
          ne >= z && ne < T
            ? w > T
              ? (P[J] = T)
              : P.splice(J, 2)
            : ne < z && w > z && (w <= T ? (P[F] = z) : P.splice(F, 0, z, T));
      for (F = 0, J = P.length, R = 0; F < J; F += 2) R += P[F + 1] - P[F];
    }
    return V.sort();
  }
  ...
  function N(P) {
    ...
    (R.position = "absolute"),
      ...
      (V.height = "100%"),
      (V.backgroundImage =
        "url(https://djjjk9bjm164h.cloudfront.net/petal.png)"),
      (V.backgroundSize = "100% 100%"),
      (R.perspective = "50px"),
      (R.transform = "rotate(" + 360 * e() + "deg)"),
      (this.axis = "rotate3D(" + n(360 * e()) + "," + n(360 * e()) + ",0,"),
      (this.theta = 360 * e()),
      (this.dTheta = f + a * e()),
      (V.transform = this.axis + this.theta + "deg)"),
      ...
      (this.splineX = _()),
      (this.splineY = []);
    for (var ie = 1, F = this.splineX.length - 1; ie < F; ++ie)
      this.splineY[ie] = p * e();
    (this.splineY[0] = this.splineY[F] = p * e()),
      (this.update = function (J, _e) {
        (this.frame += _e),
          (this.x += this.dx * _e),
          (this.y += this.dy * _e),
          (this.theta += this.dTheta * _e);
        for (
          var ne = (this.frame % 7777) / 7777, w = 0, z = 1;
          ne >= this.splineX[z];
        ...
        var T = d(
          this.splineY[w],
          this.splineY[z],
          (ne - this.splineX[w]) / (this.splineX[z] - this.splineX[w]),
        );
        return (
          (ne *= l),
          (R.left = this.x + T * n(ne) + "px"),
          (R.top = this.y + T * t(ne) + "px"),
          (V.transform = this.axis + this.theta + "deg)"),
          this.y > J + p
        );
      });
  ...
  function A() {
    if (!o) {
      document.body.appendChild(E),
        (function R() {
          var V = new N();
          u.push(V), E.appendChild(V.outer), (i = setTimeout(R, s * e()));
        })();
      var P = void 0;
      requestAnimationFrame(function R(V) {
        var ie = P ? V - P : 0;
        P = V;
        for (var F = window.innerHeight, J = u.length - 1; J >= 0; --J)
          u[J].update(F, ie) && (E.removeChild(u[J].outer), u.splice(J, 1));
        if (i || u.length) return (o = requestAnimationFrame(R));
        document.body.removeChild(E), (o = void 0);
      });
    }
  }
  A();
...
function Md() {
  return ll.useEffect(() => Rd(), []), Mr.jsx(Mr.Fragment, {});
}
Yl.createRoot(document.getElementById("root")).render(
  Mr.jsx(gc.StrictMode, { children: Mr.jsx(Md, {}) }),
);
